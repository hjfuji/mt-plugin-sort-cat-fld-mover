...
%Lexicon = (
    ...
    'Mover plugin from SortCatFld plugin to Movable Type 5.1 native category / folder sorting function.' => 'SortCatFldプラグインから、Movable Type 5.1標準のカテゴリ／フォルダ並べ替え機能への移行を行います。',
